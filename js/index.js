$(function() {
	...
	c.load("<div class='bef_comment writecode'>&nbsp;*hi,我的名字叫李蔚鹏，是刚入大三的小工程师</div>");
	c.load("<div class='bef_comment writecode'>&nbsp;*身为程序员，我的主要工作当然是负责码代码啦</div>",2000);
	c.load("<div class='bef_comment writecode'>&nbsp;*现在让我们来点实际的，看看我能做些什么吧</div>");
	...
	c.load("<div class='bef_comment writecode'>&nbsp;*/</div></p>");
	c.load("<p><div class='code writecode'><span class='bef_selector'>.comment</span>&nbsp;{ <span class='bef_key'>color</span>: <span class='bef_value'>#C0C0C0</span>; <span class='bef_key'>font-style</span>: <span class='bef_value'>italic</span>; }</div>");
	...
	w.load("<p><div class='writecode'>李蔚鹏</div>");
	w.load("<div class='writecode'>软件工程师(湖南财经)</div>");
	w.load("<div class='writecode'>后端/Java 工程师</div></p>");
	w.load("<h1 class='writecode'>联系我</h1>");
	w.load("<ul>");
	w.load("<li class='writecode'>mail:2960289474@qq.com</li>");
	w.load("<li class='writecode'>space:<a href='https://user.qzone.qq.com/2960289474/infocenter' target='_blank'>https://user.qzone.qq.com/2960289474/infocenter/</a></li>");
	w.load("<li class='writecode'>github:<a href='https://lwplovehxq.github.io/LWP/' target='_blank'>https://lwplovehxq.github.io/LWP/</a></li>");
	w.load("</ul>");
	w.load("<h1 class='writecode'>技能</h1>");
	w.load("<ul>");
	w.load("<li class='writecode'>熟悉office等办公软件，有过多年文档型数据库开发管理经验</li>");
	w.load("<li class='writecode'>熟悉SQLServer、MySQL、PLSQL等数据库操作，精通Oracle数据库操作</li>");
	w.load("<li class='writecode'>熟练各种Web前端开发技术H5,CSS3,jQuery,React,Angular</li>");
	w.load("<li class='writecode'>熟悉C++、JAVA等编程语言</li>");
	w.load("<li class='writecode'>熟练使用Android Studio开发，Dreamweaver 开发，Eclipse开发</li>");
	w.load("<li class='writecode'>熟练windows server,linux服务器部署和管理，及常见问题的处理</li>");
	w.load("<li class='writecode'>熟练Adobe Illustrator矢量绘图，Photoshop 位图绘图，Premiere Pro剪辑制作等工具</li>");
	w.load("<li class='writecode'>熟练After Effects特效后期生成，Audition音频编辑，Cinema4D的等3D模型制作等</li>");
	w.load("<li class='writecode'>熟练而较为全面掌握通信及计算机网络专业知识</li>");
	w.load("</ul>");
	...
	c.load("<div class='comment writecode'>&nbsp;*QQ/微信:2960289474</div>");
	c.load("<div class='comment writecode'>&nbsp;*mobile:173****1162</div>");
